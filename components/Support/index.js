...
const Support = () => {
    return (
        <section id="support" className="py-20 px-12 bg-gradient-to-br from-[#A3B1E0]/20 to-white">
            <div className="container mx-auto px-4">
                {/* Header */}
                <div className="text-center mb-16">
                    <h2 className="text-4xl font-bold text-[#4059AC] mb-4">
                ...
                <div className="grid lg:grid-cols-2 gap-8 items-center">
                    ...
                    <div className="space-y-8">
                        {/* Feature 1 */}
                        <div className="flex items-start space-x-4 p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                            <div className="w-16 h-16 rounded-full bg-[#A3B1E0] flex items-center justify-center flex-shrink-0">
                        ...
                        <div className="flex items-start space-x-4 p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                            <div className="w-16 h-16 rounded-full bg-[#FFD700] flex items-center justify-center flex-shrink-0">
                                <MdOutlineSpeed className="text-3xl text-white" />
                            </div>
                            <div>
                        ...
                        {/* Feature 3 */}
                        <div className="flex items-start space-x-4 p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                            <div className="w-16 h-16 rounded-full bg-[#98FB98] flex items-center justify-center flex-shrink-0">
                                <TbPigMoney className="text-3xl text-white" />
                            </div>
                            <div>
                        ...
                        {/* Feature 4 */}
                        <div className="flex items-start space-x-4 p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                            <div className="w-16 h-16 rounded-full bg-[#FF9999] flex items-center justify-center flex-shrink-0">
